			...
			<div
				...
				<div class="offer-item__add">
					<div class="offer-item__form">
						...
						<input
							readonly="readonly"
							<?if($arItem["PROPERTIES"]["MIN_LIMIT"]["VALUE"] <> ''){?>
								data-min="<?=$arItem["PROPERTIES"]["MIN_LIMIT"]["VALUE"]?>"
							<?} else {?>
								<?=$arItem['PROPERTIES']['TIPTOVARA']['STEP'] <> '' ? 'data-min="'.$arItem['PROPERTIES']['TIPTOVARA']['STEP'].'"' : "";?>
							<?}?>
