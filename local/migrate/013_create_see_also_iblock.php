<?php
/**
 * Создает инфоблок «Каталог: смотрите также»
 *
 ...
 * Создает инфоблок «Каталог: смотрите также»
 *
 * Class CreateCatalogSeeAlsoIBlockMigration
 */
class CreateCatalogSeeAlsoIBlockMigration extends AbstractIBlockMigration
{
    /**
     * {@inheritdoc}
     */
    public function up()
    {
        ...
        try {
            $this->createIBlock(
                array(
                    'ACTIVE'           => 'Y',
                    'NAME'             => 'Каталог: смотрите также',
                    'CODE'             => 'catalogSeeAlsoIBlockId',
            ...
            $logger->log(
                sprintf('IBlock has been created. Id: "%s". Add to "catalogSeeAlsoIBlockId"', $this->iblockId)
            );
    ...
    public function down()
    {
        ...
        $this->deleteIBlock($environment->get('catalogSeeAlsoIBlockId'));

        $logger->log(sprintf('IBlock rewards has been removed. Id: "%s"', $this->iblockId));
    }
}

$migration = new CreateCatalogSeeAlsoIBlockMigration();
$migration->up();
?>
